...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto',verbose=1, save_best_only=True, filepath = '/content/drive/MyDrive/save/keras28_2_MCP.hdf5')

model.fit(x_train, y_train, epochs=10000, batch_size=5, validation_split=0.11111111, callbacks=[es,mcp])
model.save("/content/drive/MyDrive/save/keras_028.2_diabets_save_model.h5")
...
model2 = load_model('/content/drive/MyDrive/save/keras_028.2_diabets_save_model.h5')
...
model3 = load_model('/content/drive/MyDrive/save/keras28_2_MCP.hdf5')
...
'''
============================1. 기본 출력=======================
2/2 [==============================] - 0s 8ms/step - loss: 4207.1738
loss:  4207.173828125
r2스코어 :  0.4713729065851141
============================2. load_model 출력=======================
2/2 [==============================] - 0s 7ms/step - loss: 4207.1738
loss2:  4207.173828125
r2스코어 :  0.4713729065851141
============================3. ModelCheckPoint 출력=======================
2/2 [==============================] - 0s 7ms/step - loss: 3768.3264
loss3:  3768.326416015625
r2스코어 :  0.5265136388569496
'''
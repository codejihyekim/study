...
from tensorflow.keras.layers import Dense, LSTM, Embedding, Input, Flatten  # Embedding: 좌표로 change
...
model.add(Embedding(input_dim=28, output_dim=10,
                    input_length=5))  # Embedding:원핫인코딩안한것들을 벡터화해주는 것 / Embedding에서만 input_dim이 output이 아니다.
model.add(Flatten())
...
=================================================================
 embedding_1 (Embedding)     (None, 5, 10)             280       
